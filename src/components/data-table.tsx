...
const columns: ColumnDef<z.infer<typeof schema>>[] = [
  ...
  },
  {
    ...
    header: 'Apellido',
    cell: ({ row }) => <div className="w-32">{row.original.apellido}</div>,
  },
  {
    accessorKey: 'correo',
    header: 'Correo',
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <Badge variant="outline" className="text-muted-foreground px-1.5">
        {row.original.deuda === 'true' || row.original.deuda ? (
          <>
            <IconCircleX className="fill-red-500 dark:fill-red-400" /> Sin pagar
          </>
        ) : (
          <>
            <IconCircleCheckFilled className="fill-green-500 dark:fill-green-400" /> Pagado
          </>
        )}
      </Badge>
    ),
      ...
      <form
        onSubmit={(e) => {
          ...
          toast.promise(new Promise((resolve) => setTimeout(resolve, 1000)), {
            loading: `Guardando objetivo de ${row.original.nombre}`,
            success: 'Guardado',
            error: 'Error',
          })
        }}
    ...
    cell: ({ row }) => (
      <form
        onSubmit={(e) => {
          e.preventDefault()
          toast.promise(new Promise((resolve) => setTimeout(resolve, 1000)), {
            loading: `Guardando peso de ${row.original.nombre}`,
            success: 'Guardado',
            error: 'Error',
          })
        }}
    ...
    <Tabs defaultValue="outline" className="w-full flex-col justify-start gap-6">
      <div className="flex items-center justify-between px-4 lg:px-6">
        ...
        <Select defaultValue="outline">
          ...
          <SelectContent>
            <SelectItem value="outline">Pacientes</SelectItem>
        ...
        <TabsList className="**:data-[slot=badge]:bg-muted-foreground/30 hidden **:data-[slot=badge]:size-5 **:data-[slot=badge]:rounded-full **:data-[slot=badge]:px-1 @4xl/main:flex">
          <TabsTrigger value="outline">Pacientes</TabsTrigger>
          ...
          <TabsTrigger value="focus-documents">Documentos de Enfoque</TabsTrigger> */}
        </TabsList>
        ...
        <div className="flex items-center justify-between px-4">
          ...
          <div className="flex w-full items-center gap-8 lg:w-fit">
            ...
            <div className="ml-auto flex items-center gap-2 lg:ml-0">
              ...
              >
                <span className="sr-only">Ve la primera página</span>
                <IconChevronsLeft />
              </Button>
              <Button
                variant="outline"
                ...
                disabled={!table.getCanPreviousPage()}
              >
                <span className="sr-only">Ve la página anterior</span>
                <IconChevronLeft />
              </Button>
              <Button
                variant="outline"
              ...
              >
                <span className="sr-only">Ve la página siguiente</span>
                <IconChevronRight />
              </Button>
              <Button
                variant="outline"
                ...
                disabled={!table.getCanNextPage()}
              >
                <span className="sr-only">Ve la última página</span>
                <IconChevronsRight />
              </Button>
            </div>
          </div>
    ...
    <Drawer direction={isMobile ? 'bottom' : 'right'}>
      ...
      <DrawerContent>
        <DrawerHeader className="gap-1">
          ...
          <DrawerDescription>Progreso durante los dias</DrawerDescription>
        </DrawerHeader>
            ...
            <>
              ...
              <div className="grid gap-2">
                <div className="flex gap-2 leading-none font-medium">
                  Grafica con resultados <IconTrendingUp className="size-4" />
                </div>
                <div className="text-muted-foreground">
                  Muestra el progreso de {item.nombre} durante los ultimos meses.
                </div>
              </div>
              <Separator />
            </>
